...
modelSetup = {
    ...
    page = {
        {enable=1, name = language.language, type=COMBO, setting="model", value="language", options={"english", "Deutsch"}, reinit=1},
        {enable=1, name = language.modelType, type=COMBO, setting="model", value="type", options={language.car, language.bike, language.crawler}, reinit=1},
        {enable=1, name=language.ztsOption, type=CHECKBOX, setting="model", value="ZTS", reinit=1}
    },
    subpage = {
        {enable=1, name=language.ztmOption, type=CHECKBOX, setting="model", value="ZTM", reinit=1},
        {enable=1, name=language.switchWarning, type=CHECKBOX, setting="model", value="sWarning"},
        {enable=1, name=language.modul, type=COMBO, setting="model", value="modul", options={"---", "CRSF"}}
    }
}
